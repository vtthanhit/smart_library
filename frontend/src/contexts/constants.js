...
export const FIND_BOOK_SKU = 'FIND_BOOK_SKU'
...
export const BOOK_LOT = 'BOOK_LOT'
...
export const REQUESTS_RETURN_LOADED_SUCCESS = 'REQUESTS_RETURN_LOADED_SUCCESS'
export const REQUESTS_RETURN_LOADED_FAIL = 'REQUESTS_RETURN_LOADED_FAIL'
